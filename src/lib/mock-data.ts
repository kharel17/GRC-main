...
export const mockEvidence: Evidence[] = [
  {
    ...
    file_path: '/documents/access-control-report.pdf',
    file_name: 'access-control-report.pdf',
    fileType: 'pdf',
    fileSize: 2048000,
    relatedTo: 'control',
    related_to: 'control',
    related_id: 'control-1',
  ...
  },
  {
    ...
    file_path: '/documents/dpo-notification.pdf',
    file_name: 'dpo-notification.pdf',
    fileType: 'pdf',
    fileSize: 512000,
    relatedTo: 'compliance_item',
    related_to: 'compliance_item',
    related_id: 'comp-1',
